...
struct result_of<F(Args...),
                 decltype(void(detail::INVOKE(gxx::declval<F>(), gxx::declval<Args>()...)))> {
    using type = decltype(detail::INVOKE(gxx::declval<F>(), gxx::declval<Args>()...));
};
} // namespace detail
...
public:
  ...
  reference_wrapper(T& ref) noexcept : _ptr(gxx::addressof(ref)) {}
